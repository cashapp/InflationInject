...
```groovy
compileOnly 'com.squareup.inject:assisted-inject-annotations:0.2.1'
annotationProcessor 'com.squareup.inject:assisted-inject-processor:0.2.1'
```
...
annotationProcessor 'com.squareup.inject:assisted-inject-processor-dagger2:0.2.1'
```
