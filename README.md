...
```groovy
compileOnly 'com.squareup.inject:assisted-inject-annotations:0.2.0'
annotationProcessor 'com.squareup.inject:assisted-inject-processor:0.2.0'
```

With Dagger 2:

```groovy
compileOnly 'com.squareup.inject:assisted-inject-annotations-dagger2:0.2.0'
annotationProcessor 'com.squareup.inject:assisted-inject-processor-dagger2:0.2.0'
```
