    ...
    (typeWrappersWithFactories + typeWrappersWithAssisted)
        ...
        .forEach {
          try {
            ...
            val assistedInjection = request.toInjection()
            val generatedTypeSpec = assistedInjection.brewJava()
                .toBuilder()
                .addOriginatingElement(request.type)
                .addOriginatingElement(request.factoryType)
                .build()
...
internal data class AssistedInjectRequest(
